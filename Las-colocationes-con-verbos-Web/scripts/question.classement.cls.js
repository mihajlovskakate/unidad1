var QuestionClassement = Class.create({
    ...
    addChoice: function(choice, goodPosition){
        ...
        for(i = 0;i < this.choices.length;i++){
            ...
            if (this.orientation == 0){
                if ((i + 1) < this.choices.length){
                    if (this.elementType == 0)
                        $('idChoices').innerHTML = $('idChoices').innerHTML + "<img src=\"images/skin/pagechoicesep.png\" border=\"0\">";
                    else if (this.elementType == 1)
                        $('idChoices').innerHTML = $('idChoices').innerHTML + "<img src=\"images/skin/pagechoicesep.png\" border=\"0\" style=\"margin-bottom:10px;\">";
                }
            }
            else if (this.orientation == 1){
                if (this.elementType == 0)
                    $('idChoices').innerHTML = $('idChoices').innerHTML + "<img src=\"images/base/spacer.gif\" border=\"0\"><div style=\"height:10px;\"><br />"; //doit avoir spacer.gif + <br /> sinon, bogue weird IE8: le drag se met "en-dessous" du classeur...
                else if (this.elementType == 1){
                    $('idChoices').innerHTML = $('idChoices').innerHTML + "<img src=\"images/base/spacer.gif\" border=\"0\"><br />";
                }
            }
        }
    ...
    validate: function(){
              ...
              for(j = 0;j < splitContainer.length;j++){
                  if (splitContainer[j] != ''){
                      ...
                      if (this.elementType == 0){
                          ...
                          validateInnerHTML[indexValue] = validateInnerHTML[indexValue] + "<span class=\"" + styleFeedback + "\">" + choice + "</span>" + "<br /><div class=\"emptyLineElements\"></div>";
                      }
                      else if (this.elementType == 1){
                          styleFeedback = "img" + styleFeedback;
                          validateInnerHTML[indexValue] = validateInnerHTML[indexValue] + "<img src=\"" + document.getElementById(idDragContentOnly).value + "\" class=\"" + styleFeedback + "\">" + "&nbsp;&nbsp;";
                      }
                  }
              }
        }
        ...
        if (counterDragged == this.choices.length){
